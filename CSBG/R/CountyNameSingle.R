#'  CountyNameSingle : Produces a vector of County Names from an input list of Census County and Place Name Codes.
#'
#' @param  infips List of county fips codes
#' @return the List of County names for  the infips list
#' @export

CountyNameSingle <- function(infips){

    tmpname <- switch(infips,
                      "08001"	= "Adams County",
